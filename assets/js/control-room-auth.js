...
async function startControlRoom() {
  ...
  await loadClassicScript("/assets/js/control-room.js?v=20260824-0055-polish-v3");
  await loadClassicScript("/assets/js/control-room-live.js?v=20260824-0055-polish-v3");
}
